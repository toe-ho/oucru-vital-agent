  ...
  theme: {
    extend: {
      colors: {
        ...
        uncomputable: {
          DEFAULT: "hsl(var(--uncomputable) / <alpha-value>)",
          foreground: "hsl(var(--uncomputable-foreground) / <alpha-value>)",
        },
        stale: {
          DEFAULT: "hsl(var(--stale) / <alpha-value>)",
          foreground: "hsl(var(--stale-foreground) / <alpha-value>)",
        },
